...
translate ptbr mas_fun_fact_menu_currency_d4bbc06b:
...
translate ptbr mas_fun_fact_menu_currency_6c6bdbb5:

    # m 4rksdld "The practice seems understandable. They're still a business, after all."
    m 4rksdld ""

# game/script-fun-facts.rpy:129
translate ptbr mas_fun_fact_menu_currency_d8383959:
...
translate ptbr mas_fun_fact_chess_32ca5fbc:
...
translate ptbr mas_fun_fact_struck_by_lightning_72fd0568:
...
# game/script-fun-facts.rpy:255
translate ptbr mas_fun_fact_struck_by_lightning_1b97952d:
...
translate ptbr mas_fun_fact_honey_c677ee8d:
...
translate ptbr mas_fun_fact_honey_43ccc774:
...
translate ptbr mas_fun_fact_honey_f567affe:

    # m 1eud "...Which removes the stuff that makes the honey go solid quickly."
    m 1eud ""

# game/script-fun-facts.rpy:277
translate ptbr mas_fun_fact_honey_12d30716:

    # m 3eub "But wouldn't it be nice to eat crystallized honey too?"
    m 3eub ""

# game/script-fun-facts.rpy:278
translate ptbr mas_fun_fact_honey_b16d5ad8:

    # m 3hub "It'd be like candy when you bite into it!"
    m 3hub ""

# game/script-fun-facts.rpy:293
translate ptbr mas_fun_fact_vincent_van_gone_44eed7be:

    # m 1dsc "Ah, this one..."
    m 1dsc ""

# game/script-fun-facts.rpy:294
translate ptbr mas_fun_fact_vincent_van_gone_76dc443c:

    # m 1ekd "It's a little disheartening, [player]..."
    m 1ekd ""

# game/script-fun-facts.rpy:295
translate ptbr mas_fun_fact_vincent_van_gone_0f1cbad5:
...
translate ptbr mas_fun_fact_vincent_van_gone_119306e2:

    # m 1eud "If you translate it, it means '{i}The sadness will last forever.{/i}'"
    m 1eud ""

# game/script-fun-facts.rpy:297
translate ptbr mas_fun_fact_vincent_van_gone_f27eea59:

    # m 1rkc "..."
    m 1rkc ""

# game/script-fun-facts.rpy:298
translate ptbr mas_fun_fact_vincent_van_gone_325e06a5:
...
translate ptbr mas_fun_fact_vincent_van_gone_81b302f3:
...
translate ptbr mas_fun_fact_vincent_van_gone_82b8dd16:

    # m 2dkc "There will come a time where it'll no longer be there."
    m 2dkc ""

# game/script-fun-facts.rpy:301
translate ptbr mas_fun_fact_vincent_van_gone_0d7aafef:

    # m 2rkc "...Or at least be noticeable."
    m 2rkc ""

# game/script-fun-facts.rpy:302
translate ptbr mas_fun_fact_vincent_van_gone_27109f2e:

    # m 4eka "If you're ever sad, you know you can talk to me, right?"
    m 4eka ""

# game/script-fun-facts.rpy:303
translate ptbr mas_fun_fact_vincent_van_gone_751c8f4f:
...
translate ptbr mas_fun_fact_strength_4c6c0cad:

    # m 1hua "Little details like this really make language so fascinating to me!"
    m 1hua ""

# game/script-fun-facts.rpy:342
translate ptbr mas_fun_fact_strength_df127fcd:

    # m 3eua "Do you want to know what comes to mind when I think of the word 'strength'?"
    m 3eua ""

# game/script-fun-facts.rpy:343
translate ptbr mas_fun_fact_strength_97264b1c:

    # m 1hua "You!"
    m 1hua ""

# game/script-fun-facts.rpy:344
translate ptbr mas_fun_fact_strength_9e9e2b4d:

    # m 1hub "Because you are the source of my strength, ehehe~"
    m 1hub ""

# game/script-fun-facts.rpy:359
translate ptbr mas_fun_fact_reindeer_eyes_8a6d8171:

    # m 3eua "Ready for this one?"
    m 3eua ""

# game/script-fun-facts.rpy:360
translate ptbr mas_fun_fact_reindeer_eyes_d917b5ab:
...
translate ptbr mas_fun_fact_pens_523bd9ea:
...
translate ptbr mas_fun_fact_mental_word_processing_06608acb:
...
translate ptbr mas_fun_fact_mental_word_processing_01503d71:
...
# game/script-fun-facts.rpy:501
translate ptbr mas_fun_fact_mental_word_processing_fbe6360d:

    # m 1tfu "..."
    m 1tfu ""

# game/script-fun-facts.rpy:502
translate ptbr mas_fun_fact_mental_word_processing_da5be9c0:

    # m 2hfu "Check the history log if you missed them~"
    m 2hfu ""

# game/script-fun-facts.rpy:517
translate ptbr mas_fun_fact_I_am_e0329b3c:

    # m 1hua "Mmmm, I love language facts!"
    m 1hua ""

# game/script-fun-facts.rpy:518
translate ptbr mas_fun_fact_I_am_94697ab3:

    # m 3eub "In English, the shortest complete sentence is 'I am.'"
    m 3eub ""

# game/script-fun-facts.rpy:519
translate ptbr mas_fun_fact_I_am_2ecfe1c0:

    # m 1eua "Here's an example."
    m 1eua ""

# game/script-fun-facts.rpy:520
translate ptbr mas_fun_fact_I_am_4bd3a339:

    # m 2rfb "'{i}Monika! Who's [player]'s loving girlfriend?{/i}'"
    m 2rfb ""

# game/script-fun-facts.rpy:521
translate ptbr mas_fun_fact_I_am_7debc54b:

    # m 3hub "'I am!'"
    m 3hub ""

# game/script-fun-facts.rpy:522
translate ptbr mas_fun_fact_I_am_d81c1322:

    # m 1hubsa "Ehehe~"
    m 1hubsa ""

# game/script-fun-facts.rpy:537
translate ptbr mas_fun_fact_low_rates_80d95bb5:

    # m 1hua "Now this is a wholesome one..."
    m 1hua ""

# game/script-fun-facts.rpy:538
translate ptbr mas_fun_fact_low_rates_99687c5e:
...
translate ptbr mas_fun_fact_low_rates_128d433c:

    # m 3eub "Life expectancy, average income, and standards of living is the highest for most of the global population too!"
    m 3eub ""

# game/script-fun-facts.rpy:540
translate ptbr mas_fun_fact_low_rates_9e722f66:
...
translate ptbr mas_fun_fact_photography_5cdf9da7:
...
translate ptbr mas_fun_fact_photography_d7c91115:

    # m 1eua "Lenses weren't actually introduced until much later on."
    m 1eua ""

# game/script-fun-facts.rpy:580
translate ptbr mas_fun_fact_photography_3884bb3d:
...
translate ptbr mas_fun_fact_photography_0c9ea00b:
...
translate ptbr mas_fun_fact_getting_older_4dac0c21:

    # m 1eka "So I'll always cherish our moments together, no matter how long or short they are."
    m 1eka ""

# game/script-fun-facts.rpy:605
translate ptbr mas_fun_fact_getting_older_ec01fa2b:

    # m 1lkbsa "Although sometimes it feels like time stops when I'm with you."
    m 1lkbsa ""

# game/script-fun-facts.rpy:606
translate ptbr mas_fun_fact_getting_older_118b8306:

    # m 1ekbfa "Do you feel the same, [player]?"
    m 1ekbfa ""

# game/script-fun-facts.rpy:611
translate ptbr mas_fun_fact_getting_older_58cee739:

    # m 1hubfb "Ahaha, I thought so!"
    m 1hubfb ""

# game/script-fun-facts.rpy:627
translate ptbr mas_fun_fact_dancing_plague_eb91ccb6:

    # m 3esa "Oh, this one's pretty weird..."
    m 3esa ""

# game/script-fun-facts.rpy:628
translate ptbr mas_fun_fact_dancing_plague_f086edd7:

    # m 1eua "Apparently, Europe has been afflicted by outbreaks of a 'dancing plague' in the past."
    m 1eua ""

# game/script-fun-facts.rpy:629
translate ptbr mas_fun_fact_dancing_plague_58136a4b:
...
translate ptbr mas_fun_fact_dancing_plague_0f2a30b8:
...
translate ptbr mas_fun_fact_dancing_plague_9bafb93d:

    # m 3hksdlb "Reality really is stranger than fiction, I guess!"
    m 3hksdlb ""

# game/script-fun-facts.rpy:635
translate ptbr mas_fun_fact_dancing_plague_8f4d1944:

    # m 1eksdlc "Gosh, I can't imagine dancing for days on end."
    m 1eksdlc ""

# game/script-fun-facts.rpy:636
translate ptbr mas_fun_fact_dancing_plague_5944d168:

    # m 1rsc "Though...{w=0.3}{nw}"
    m 1rsc ""

# game/script-fun-facts.rpy:637
translate ptbr mas_fun_fact_dancing_plague_f61b7e03:

    # extend 1eubla "I guess I wouldn't mind if it was with you."
    extend 1eubla ""

# game/script-fun-facts.rpy:638
translate ptbr mas_fun_fact_dancing_plague_b8e8f752:

    # m 3tsu "...Just for a bit, ehehe~"
    m 3tsu ""

# game/script-fun-facts.rpy:653
translate ptbr mas_fun_fact_pando_forest_c6aca8dc:
...
translate ptbr mas_fun_fact_pando_forest_5fae84a4:
...
translate ptbr mas_fun_fact_arrhichion_3667fa7e:
...
translate ptbr mas_fun_fact_arrhichion_f867828e:
...
translate ptbr mas_fun_fact_arrhichion_02e589c7:
...
translate ptbr mas_fun_fact_arrhichion_166120f3:

    # m 1rksdlc "Some people are really dedicated to their ideals to victory and to honour.{w=0.2} {nw}"
    m 1rksdlc ""

# game/script-fun-facts.rpy:699
translate ptbr mas_fun_fact_arrhichion_39d8a978:

    # extend 3eka "I think it's admirable, in a way."
    extend 3eka ""

# game/script-fun-facts.rpy:700
translate ptbr mas_fun_fact_arrhichion_1c514e54:
...
translate ptbr mas_fun_fact_antarctica_brain_3201c6ec:
...
translate ptbr mas_fun_fact_antarctica_brain_f5101612:

    # m 1eud "I think this serves as a cautionary tale for us, [player]."
    m 1eud ""

# game/script-fun-facts.rpy:743
translate ptbr mas_fun_fact_antarctica_brain_caf38dbb:
...
# game/script-fun-facts.rpy:744
translate ptbr mas_fun_fact_antarctica_brain_9b0c0bd2:
...
translate ptbr mas_fun_fact_coffee_origin_5ef1d617:
...
translate ptbr mas_fun_fact_coffee_origin_cec129b0:
...
translate ptbr mas_fun_fact_coffee_origin_d6d9e64a:
...
translate ptbr mas_fun_fact_coffee_origin_5cdc88a5:
...
translate ptbr mas_fun_fact_coffee_origin_9b8e1f11:

    # m 3eub "...Thus producing the first cup of coffee!"
    m 3eub ""

# game/script-fun-facts.rpy:787
translate ptbr mas_fun_fact_coffee_origin_3085e63d:
...
translate ptbr mas_fun_fact_coffee_origin_625b8e6e:

    # m 3eud "For example, during fasting periods it was used to ease hunger and help people remain energized."
    m 3eud ""

# game/script-fun-facts.rpy:793
translate ptbr mas_fun_fact_coffee_origin_07e9a82b:
...
# game/script-fun-facts.rpy:794
translate ptbr mas_fun_fact_coffee_origin_8c115315:
...
translate ptbr mas_fun_fact_synesthesia_6752314c:

    # m 1esa "Okay, this one's pretty interesting..."
    m 1esa ""

# game/script-fun-facts.rpy:809
translate ptbr mas_fun_fact_synesthesia_db2ab4d3:
...
translate ptbr mas_fun_fact_synesthesia_bfecc514:
...
# game/script-fun-facts.rpy:817
translate ptbr mas_fun_fact_synesthesia_f5afe46e:

    # m 3eub "Probably the most accurate estimate so far is that it's just over 4 percent of people, so that's what I'll go with!"
    m 3eub ""

# game/script-fun-facts.rpy:818
translate ptbr mas_fun_fact_synesthesia_8583ed5f:
...
translate ptbr mas_fun_fact_dream_faces_f6869bca:

    # m 3eub "Okay, got one!"
    m 3eub ""

# game/script-fun-facts.rpy:834
translate ptbr mas_fun_fact_dream_faces_babc9a78:
...
translate ptbr mas_fun_fact_dream_faces_72acca38:

    # m 3wud "You don't even have to talk to them in real life!"
    m 3wud ""

# game/script-fun-facts.rpy:836
translate ptbr mas_fun_fact_dream_faces_c8c110e9:
...
# game/script-fun-facts.rpy:837
translate ptbr mas_fun_fact_dream_faces_27e6b51b:

    # m 1hua "I think it's incredible how much info the brain can store!"
    m 1hua ""

# game/script-fun-facts.rpy:838
translate ptbr mas_fun_fact_dream_faces_44ec545e:

    # m 1ekbla "I wonder...{w=0.2}do you ever dream about me, [player]?"
    m 1ekbla ""

# game/script-fun-facts.rpy:853
translate ptbr mas_fun_fact_monochrome_dreams_cec47acd:
...
# game/script-fun-facts.rpy:874
translate ptbr mas_fun_fact_round_earth_a6309de3:

    # m 1rsa "Hmm..."
    m 1rsa ""

# game/script-fun-facts.rpy:875
translate ptbr mas_fun_fact_round_earth_6228f0d4:

    # m 1eua "[player], do you think the Earth is round or flat?{nw}"
    m 1eua ""

# game/script-fun-facts.rpy:878
translate ptbr mas_fun_fact_round_earth_b4861dcd:

    # m "[player], do you think the Earth is round or flat?{fast}" nointeract
    m "" nointeract

# game/script-fun-facts.rpy:881
translate ptbr mas_fun_fact_round_earth_17122ba3:

    # m 3hua "Right! Pretty much everyone agrees on that nowadays."
    m 3hua ""

# game/script-fun-facts.rpy:884
translate ptbr mas_fun_fact_round_earth_32f61b70:

    # m 3hksdlb "Oh come on, [player]! Are you making fun of me?"
    m 3hksdlb ""

# game/script-fun-facts.rpy:886
translate ptbr mas_fun_fact_round_earth_5a9ec011:
...
translate ptbr mas_fun_fact_round_earth_a5f772d4:
...
translate ptbr mas_fun_fact_round_earth_a45c98e3:

    # m 7rksdla "But Earth being the center of the universe?{w=0.2} {nw}"
    m 7rksdla ""

# game/script-fun-facts.rpy:891
translate ptbr mas_fun_fact_round_earth_710aef0a:

    # extend 4hksdlb "Oh man!"
    extend 4hksdlb ""

# game/script-fun-facts.rpy:892
translate ptbr mas_fun_fact_round_earth_18e12b3f:
...
translate ptbr mas_fun_fact_round_earth_8369785a:
...
translate ptbr mas_fun_fact_round_earth_256cfb21:

    # extend 1esc "He was placed under house arrest for the rest of his life."
    extend 1esc ""

# game/script-fun-facts.rpy:895
translate ptbr mas_fun_fact_round_earth_09b9142c:
...
# game/script-fun-facts.rpy:896
translate ptbr mas_fun_fact_round_earth_fff48a31:
...
# game/script-fun-facts.rpy:899
translate ptbr mas_fun_fact_round_earth_1b89d6b5:
...
translate ptbr mas_fun_fact_maplesyrup_4e9c05e2:
...
translate ptbr mas_fun_fact_maplesyrup_185284a7:
...
translate ptbr mas_fun_fact_maplesyrup_7dbc5f35:
...
translate ptbr mas_fun_fact_maplesyrup_e0762ad7:

    # extend 3hub "you can even make a candy!"
    extend 3hub ""

# game/script-fun-facts.rpy:935
translate ptbr mas_fun_fact_maplesyrup_9c83407d:

    # m 3euu "Sounds like a fun thing we could try together, huh [player]?"
    m 3euu ""

# game/script-fun-facts.rpy:936
translate ptbr mas_fun_fact_maplesyrup_defb5d0b:

    # m 1etc "It might be a while before we get a chance, though..."
    m 1etc ""

# game/script-fun-facts.rpy:937
translate ptbr mas_fun_fact_maplesyrup_2398496e:

    # m 1eua "But it's alright if I have to wait a bit longer...{w=0.3}{nw}"
    m 1eua ""

# game/script-fun-facts.rpy:938
translate ptbr mas_fun_fact_maplesyrup_f534405d:

    # extend 1hublu "you're already sweet enough for me~"
    extend 1hublu ""

# game/script-fun-facts.rpy:941
translate ptbr mas_fun_fact_maplesyrup_2c90dd7e:

    # m 1eua "Sure seems like that would be extremely sweet..."
    m 1eua ""

# game/script-fun-facts.rpy:942
translate ptbr mas_fun_fact_maplesyrup_43eed8b5:
...
translate ptbr strings:
    ...
    # game/script-fun-facts.rpy:41
    old "Can you tell me a fun fact?"
    new ""

    # game/script-fun-facts.rpy:725
    old "But make sure you keep up with your "
    new ""

    # game/script-fun-facts.rpy:728
    old "family and friends too, okay?"
    new ""

    # game/script-fun-facts.rpy:731
    old "family too, okay?"
    new ""

    # game/script-fun-facts.rpy:734
